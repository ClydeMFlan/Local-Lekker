-- Migration: Update complete_merchant_signup RPC to save surname to profiles table
-- This migration modifies the RPC to store the surname separately in the profiles table

begin;

-- Drop and recreate the complete_merchant_signup function to include surname saving
...
begin
  ...
  return jsonb_build_object('ok', true, 'profile_id', v_profile_id, 'merchant_id', v_merchant_id);
end;
$$;
