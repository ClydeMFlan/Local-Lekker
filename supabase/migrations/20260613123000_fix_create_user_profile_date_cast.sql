-- Hotfix: make create_user_profile robust for date_of_birth input types
-- Reason: some deployed variants fail with
-- "column date_of_birth is of type timestamp with time zone but expression is of type text"
...
BEGIN
  ...
  ON CONFLICT (id) DO UPDATE SET
    ...
    subscription = COALESCE(EXCLUDED.subscription, public.profiles.subscription),
    updated_at = NOW();
