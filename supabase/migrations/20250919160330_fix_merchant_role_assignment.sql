-- Migration: Fix trusted_partner role assignment in complete_business_profile RPC
-- Ensures that when trusted_partners complete their business profile, they get the correct 'trusted_partner' role

BEGIN;

-- Update the complete_business_profile function to ensure trusted_partner role assignment
