-- Migration: Add admin_created and password_set columns to profiles table
-- These columns track whether a user was created by an admin and if they've set their password
