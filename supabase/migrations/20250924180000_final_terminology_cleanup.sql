...
-- Step 1: Rename merchants table to trusted_partners if it still exists (already done)
-- DO $$
-- BEGIN
...
-- Step 2: Rename merchant_discounts table to trusted_partner_discounts if it still exists (already done)
-- DO $$
-- BEGIN
