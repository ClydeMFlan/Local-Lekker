-- Fix storage RLS policies for deal image uploads
-- This allows trusted partners to upload deal images to their own folders
-- and everyone to view deal images (public URLs)
