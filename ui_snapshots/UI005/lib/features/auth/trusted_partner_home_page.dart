  ...
  Widget _buildTpMemberDashboardBody() {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Wide screens (desktop / web / large tablets): centered two-column.
        if (maxWidth >= 1000) {
          return _buildTpMemberDesktopLayout(constraints);
        }
        // Landscape phones / tablets (and narrow landscape windows): compact two-column.
        if (isLandscape && maxWidth >= 600) {
          return _buildTpMemberLandscapeLayout(constraints);
        }
        // Portrait phones (and narrow windows): single column.
        return _buildTpMemberPortraitLayout();
      },
    );
  }
