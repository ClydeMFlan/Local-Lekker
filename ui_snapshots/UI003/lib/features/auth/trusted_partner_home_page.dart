...
class _TrustedPartnerHomePageState extends State<TrustedPartnerHomePage>
  ...
  Widget _buildDesktopTrustedPartnerHeroCard() {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final int rightPanelColumns = isCompactHeight ? 4 : 4;
        final double outerCardPadding = isCompactHeight ? 12 : 28;
        final double identityPanelPadding = isCompactHeight ? 14 : 24;
        final double scannerPanelPadding = isCompactHeight ? 8 : 18;
        final double logoSize = isCompactHeight ? 90 : 122;
        ...
        final double scannerMinHeight = isCompactHeight ? 86 : 214;
        final double scannerTopInset = identityPanelPadding + 2;
        final double scannerBottomInset = scannerTopInset;
        final double scannerInnerPadding = isCompactHeight ? 8 : 18;
        final double scannerTopGap = isCompactHeight ? 6 : 26;
        final double scannerIconBox = isCompactHeight ? 32 : 64;
        final double scannerIconSize = isCompactHeight ? 18 : 36;
        ...
        final double contentWidth = math.max(
          320,
          constraints.maxWidth - (outerCardPadding * 2),
        );
        ...
        final Widget identityPanel = Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: useLogoWidthActionStack ? 8 : (isCompactHeight ? 10 : 14)),
              Align(
              ...
              SizedBox(height: useLogoWidthActionStack ? 10 : bankingGap),
              AnimatedBuilder(
        ...
        final Widget scannerPanel = Container(
          ...
          child: InkWell(
            onTap: _isMobilePlatform ? _openScanner : _showDesktopScannerDialog,
            borderRadius: BorderRadius.circular(24),
            child: Container(
              height: stackVertically ? null : double.infinity,
              ...
              padding: EdgeInsets.all(scannerInnerPadding),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              colors: [Color(0xFFFFF5E6), Color(0xFFF6FBFF), Color(0xFFE9FFF8)],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ),
            border: Border.all(
              color: const Color(0xFFFFD58A).withValues(alpha: 0.55),
            ),
            boxShadow: [
              BoxShadow(
  ...
  Widget _buildDesktopScannerBody() {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final double horizontalPadding = isCompactHeight ? 12 : 28;
        final double verticalPadding = isCompactHeight ? 4 : 20;
        final double availableHeight = math.max(
          240,
          constraints.maxHeight - (verticalPadding * 2),
        );
        final double heroWidth = math.max(
