-- Fix complete_business_profile function to support logo_url
-- This updates the RPC function to accept and save logo_url to businesses table
...
DECLARE
  ...
  v_logo_url text := nullif(coalesce(payload->>'logo_url', ''), ''); -- ADD: logo_url support
...
BEGIN
  ...
  INSERT INTO public.businesses (
    ...
    SET name = excluded.name,
        ...
        logo_url = excluded.logo_url, -- UPDATE: Save logo_url on update
        verified = true
