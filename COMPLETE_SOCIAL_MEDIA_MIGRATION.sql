-- ==============================================================================
-- COMPLETE MIGRATION: Add Social Media Handles to Businesses
-- ==============================================================================
-- This script:
-- 1. Adds social media columns to businesses table
-- 2. Updates the complete_business_profile function to save these fields
-- ==============================================================================
...
-- STEP 2: Update complete_business_profile function
-- ==============================================================================
...
WHERE routine_name = 'complete_business_profile';
